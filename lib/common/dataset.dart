...
final dataSetKor = DataSet(
    ...
    companies: [
      Company(
        ...
        achievements: [
          "신규 앱 2개 런칭 및 기존 서비스 확장으로 유저 수 매달 30% 증가",
          "개발 팀 총괄 업무 담당 및 프로세스 도입으로 평균 20%의 효율성 증가",
          "사용자 리뷰 및 고객센터 문의사항 피드백으로 고객 불만사항 건수 1달 기준 75% 감소",
          "타 부서와의 커뮤니케이션 (기획, 디자인, 마케팅, CS)",
          "제품 개발 우선순위 책정 및 일정 산정",
          "배포 서비스 버전 관리 및 문서화",
          "기존 서비스 리팩토링 및 신규 서비스와 통합",
        ],
        projects: [
          Project(
            title: "그랫 - 펫택시",
            ...
            achievements: [
              "회원 수 백단위에서 만단위까지 매달 30%의 신규 유저 증가",
              "주요 반려동물 서비스들과 기술 제휴 체결로 매출 상승 기여",
              "칸반보드, 데일리 미팅 등 개발 프로세스 도입으로 업무 효율성 증가",
      ...
      Company(
        ...
        achievements: [
          "웹 수집기를 동종업계 내에서 최고 성능으로 개발한 경험",
